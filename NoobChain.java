        ...
        for(int i=1; i < blockchain.size(); i++) {
            ...
            for (int t = 0; t < currentBlock.transactions.size(); t++) {
                ...
                if (currentTransaction.outputs.get(1).reciepient != currentTransaction.sender) {
                    System.out.println("#Transaction (" + t + ") output 'chang' is not sender.");
                    return false;
                }
            }
        }
...
// *unless they have vastly more computation speed than all other nodes in your network combined. 
